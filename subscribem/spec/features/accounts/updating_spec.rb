...
require "subscribem/testing_support/factory/account_factory"
    ...
    context "with plans" do
      ...
      let(:query_string) do
        Rack::Utils.build_query(
          ...
          :hash => "c011bd4a00dd546a9ad70b9465b9a9192f839ae4")
      end
      ...
      scenario "updating an account's plan" do
        ...
        query_string = Rack::Utils.build_query(
          ...
          :id => "a_fake_id",
          :kind => "create_customer",
          :hash => "33431d91c4f081078ddb0429ab33e0770d52697d"
        )
        ...
        expect(Braintree::TransparentRedirect).to receive(:confirm).with(query_string).
        ...
        fill_in "Credit card number", with: "411111111111"
      ...
      scenario "can't change account's plan with invalid credit card number" do
        ...
        expect(Braintree::TransparentRedirect).to receive(:confirm).
          with(query_string).and_return(result)
        visit root_url
        click_link "Edit Account"
        select "Extreme", :from => 'Plan'
        click_button "Update Account"
      ...
      scenario "changing plan after inital subscription" do
